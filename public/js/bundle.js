...
function displayMap(locations) {
  ...
  L.tileLayer("https://tile.jawg.io/jawg-dark/{z}/{x}/{y}.png?access-token=uGkxLCfU6wodLu1gtpKsLSKfX5vgf8zVrtofF8LkKmNGBIgCnMBxTLMwYTyTDepN", {
  ...
  locations.forEach(function (loc) {
    ...
    marker.bindPopup("<p style='font-size: 12px; font-weight: 600'>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"), {
      autoClose: false,
      closeButton: false
    });
    marker.openPopup();
...
function showAlert(type, msg) {
  var alertDurationSeconds = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  hideAlert();
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alerts.showAlert)("error", "Unable to update your ".concat(type));
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
var stripePromise = loadStripe("pk_test_51SiD2qPuVwn1MptjjGjuVSrEQeT5L7n84xOoIywg3YYmcsMfJwyJtwRzumSrFnl0I1o8IFHJvhJ8Wlvxx5KaoPir005bHYXYub");
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          _t = _context.v;
          console.error(_t);
          (0, _alerts.showAlert)("error", _t.message);
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
if (updateUserPasswordForm) {
  updateUserPasswordForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      var btnSavePassword, passwordCurrentField, passwordField, passwordConfirmField, passwordCurrent, password, passwordConfirm;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            passwordCurrentField = document.getElementById("password-current");
            passwordField = document.getElementById("password");
            passwordConfirmField = document.getElementById("password-confirm");
            passwordCurrent = passwordCurrentField.value;
...
if (bookTourBtn) {
  ...
  bookTourBtn.addEventListener("click", _stripe.bookTour.bind(null, tourId));
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6968" + '/');
